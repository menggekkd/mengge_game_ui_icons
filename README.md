...
Some icons were modified based on [Kenney](https://x.com/KenneyNL)’s [Input Prompts](https://kenney.nl/assets/input-prompts). The font used in the icons is [MiSans](https://hyperos.mi.com/font/).
...
部分图标根据 [Kenney](https://x.com/KenneyNL) 制作的 [Input Prompts](https://kenney.nl/assets/input-prompts) 进行更改，图标使用的字体使用的是 [MiSans](https://hyperos.mi.com/font/)。
